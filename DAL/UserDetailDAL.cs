    ...
    public class UserDetailDAL
    {
        ...
        public List<UserDetail> GetAllUserDetail()
        {
            ...
            while (dr.Read())
            {
                ...
                userDetail.CountryId = Convert.ToString(dr["CountryId"]);
                userDetail.StateId = Convert.ToString(dr["StateId"]);
                userDetail.CityId = Convert.ToString(dr["CityId"]);
        ...
        public string AddUserDetail(UserDetail userDetail)
        {
            ...
            cmd.Parameters.Add("CountryId", SqlDbType.NVarChar).Value = userDetail.CountryId;
            cmd.Parameters.Add("StateId", SqlDbType.NVarChar).Value = userDetail.StateId;
            cmd.Parameters.Add("CityId", SqlDbType.NVarChar).Value = userDetail.CityId;
