...
namespace PrismAPI.Controllers
{
    public class SocialMediaController : ApiController
    {
        ...
        {
            Log.writeMessage("SocialMediaController GetAllSocialMedia  Start");
        ...
        public SocialMedia  GetSocialMediaById(int SocialMediaId)
        {
            ...
            try
            {
                socialMedia  = socialMediaDAL.GetSocialMediaById(SocialMediaId);
            }
            catch (Exception ex)
            {
                Log.writeMessage("SocialMediaController GetSocialMediaById Error " + ex.Message);
            }
        ...
        public IHttpActionResult DeleteSocialMedia(int SocialMediaId)
        {
            try
            {
                var result = socialMediaDAL.DeleteSocialMedia(SocialMediaId);
            ...
            {
                Log.writeMessage("SocialMediaController DeleteSocialMedia  Error " + ex.Message);
            }
            return Ok("Failed");
        }
